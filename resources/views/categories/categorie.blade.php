@extends('layouts.master', ['title' => 'Categorie'])
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header bg-primary">
                                            <h4 class=" text-white">Ajout d'une catégorie</h4>
                                        </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" required name="libelle"
                                                        placeholder="Entrez le nom de la catégorie" id="firstNameinput">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    @foreach ($all as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade edit-department{{ $item->id_categorie }}"
                                                    tabindex="-1" aria-labelledby="mySmallModalLabel" aria-hidden="true"
                                                    style="display: none;">
                                                    <form action="{{ route('categorie.update', $item->id_categorie) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PATCH')
                                                        <div class="modal-dialog modal-dialog-centered">
                                                ...
                                                <a href="#" class="btn btn-soft-danger btn-sm" data-bs-toggle="modal"
                                                    data-bs-target=".bs-example-modal-center{{ $item->id_categorie }}">
                                                    Supprimer
                                                </a>
                                                <div class="modal fade bs-example-modal-center{{ $item->id_categorie }}"
                                                    tabindex="-1" aria-labelledby="mySmallModalLabel" aria-hidden="true"
                                                    style="display: none;">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-body text-center p-5">
                                                                ...
                                                                <form
                                                                    action="{{ route('categorie.destroy', $item->id_categorie) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <div class="mt-4">
