@extends('layouts.master', ['title' => 'Departements'])
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                        <h4 class="mb-sm-0">Département</h4>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header bg-primary">
                                            <h4 class=" text-white">Ajout d'un Département</h4>
                                        </div>
                                        <div class="modal-body p-3">
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="firstNameinput" class="form-label">Libelle</label>
                                                    <input type="text" class="form-control" required name="libelle"
                                                        placeholder="Entrez le nom du département" id="firstNameinput">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="btn btn-soft-info btn-sm" data-bs-toggle="modal"
                                                    data-bs-target=".edit-department{{ $item->id_bureau }}">Modifier</a>
                                                <div class="modal fade edit-department{{ $item->id_bureau }}" tabindex="-1"
                                                    aria-labelledby="mySmallModalLabel" aria-hidden="true"
                                                    style="display: none;">
                                                    <form action="{{ route('departement.update', $item->id_bureau) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PATCH')
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                <div class="modal-header bg-info">
                                                                    <h4 class=" text-white">Modifier un Département</h4>
                                                                </div>
                                                                <div class="modal-body p-3">
                                                                    <div class="col-12">
                                                                        <div class="mb-3">
                                                ...
                                                <a href="#" class="btn btn-soft-danger btn-sm" data-bs-toggle="modal"
                                                    data-bs-target=".bs-example-modal-center{{ $item->id_bureau }}">
                                                    Supprimer
                                                </a>
                                                <div class="modal fade bs-example-modal-center{{ $item->id_bureau }}"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-body text-center p-5">
                                                                ...
                                                                <form
                                                                    action="{{ route('departement.destroy', $item->id_bureau) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <div class="mt-4">
