            ...
            <div class="d-flex align-items-center">
                            ...
                            <div class="p-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto dropdown-tabs">
                                        <span class="badge bg-light text-body fs-13"> 3 Nouvelle(s)</span>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item position-relative">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <h6 class="mt-0 mb-2 fs-13 lh-base">You have received 10 new messages
                                                    in the
                                                    conversation
                                                </h6>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user"
                                src="{{ Auth::user()->photo == '' ? URL::asset('assets/images/users/avatar-1.jpg') : url('users/' . Auth::user()->photo) }}"
                                alt="">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="{{ route('userss.show', Auth::user()->id) }}"><i
